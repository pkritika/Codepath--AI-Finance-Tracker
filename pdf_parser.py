...
def is_transaction_page(page) -> bool:  #counts how many transaction are there including date and amount and on the basis of that it choses if it's the mani page
    #returns false immediately if the page contains legal-words. true if more than 3 or more dates and amount and not legal words.
